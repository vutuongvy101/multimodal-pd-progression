...
class BaseDataLoader(ABC):
    ...
    def __init__(self, base_dir: str, config: Config_v2, valid_participants: Optional[pd.DataFrame] = None):
        """
        Args:
        ...
        self.config = config  # Centralized Config_v2 object - accessible by all loaders
